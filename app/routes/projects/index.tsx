...
function RepoCard({ repo }: { repo: Repo }) {
    return (
        <article className="p-4 rounded-sm bg-slate-200 grid grid-rows-[auto,1fr,auto] gap-2 hover:scale-110 transition-transform shadow-sm h-40 focus-within:scale-110 dark:bg-slate-800">
...
export default function Index() {
    ...
    return (
        <section className="container px-8 my-4 mx-auto">
