...
const PageHeader = () => {
  return (
    <header className="text-3xl bg-blue-800 dark:bg-slate-800">
      <nav className="flex gap-4 py-4 align-bottom buffer-padded">
        <Link
          to="/"
...
const PageFooter = () => {
  return (
    <footer className="text-white bg-blue-800 dark:bg-slate-800">
      <div className="p-2 buffer-padded">
...
const Spinner = () => (
  <div role="status">
    <svg
      aria-hidden="true"
      className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-200 dark:fill-cyan-200"
      viewBox="0 0 100 101"
      fill="none"
